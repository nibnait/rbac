                	...
                	for(var i =0;i<counts;i++)
                        {
                            html1+='<tr>'+
                                ...
                                '<td>'+
                               		 '<button type="button" class="btn btn-info btn-xs" onclick="lookInfo('+allInfo1[i].workNo+')">' +'详细信息</button>'+
                                '</td>'+
                                '</tr>';
                	}
					$('.manpower').append(html1);

					var allInfo2 = result.data[1].userInfoList;
                	var html2 =''
                	for(var i =0;i<counts;i++)
                	{
                			html2+='<tr>'+
									...
									'<td>'+
										'<button type="button" class="btn btn-info btn-xs" onclick="lookInfo('+allInfo2[i].workNo+')">'+'详细信息</button>'+
								'</td>'+
								'</tr>';
                	}
					$('.technology').append(html2);

					var allInfo3 = result.data[2].userInfoList;
                	var html3 =''
                	for(var i =0;i<counts;i++)
                	{
                			html3+='<tr>'+
									...
									'<td>'+
										'<button type="button" class="btn btn-info btn-xs" onclick="lookInfo('+allInfo3[i].workNo+')">'+'详细信息</button>'+
								'</td>'+
								'</tr>';
                	}
					$('.operation').append(html3);

					var allInfo4 = result.data[3].userInfoList;
                	var html4 =''
                	for(var i =0;i<counts;i++)
                	{
                			html4+='<tr>'+
									...
									'<td>'+
										'<button type="button" class="btn btn-info btn-xs" onclick="lookInfo('+allInfo4[i].workNo+')">'+'详细信息</button>'+
								'</td>'+
								'</tr>';
                	}
					$('.sale').append(html4);
