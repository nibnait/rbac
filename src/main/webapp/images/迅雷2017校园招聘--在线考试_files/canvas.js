    ...
    (function () {
        ...
        */
        ...
        function drawRectangle() {
            ...
            ctx.fillRect(x + parseInt(borderWidth), y + parseInt(borderWidth), endX - x, endY - y);
        ...
        function saveItAsImage() {
            ...
            var imgOld = $($('iframe.cke_wysiwyg_frame')[0].contentDocument.body)
                .find('img[src^="data:"]');
            var oldImg = null;
            ...
            if (oldImg)
                ...
                $($('iframe.cke_wysiwyg_frame')[0].contentDocument.body).append(img);
